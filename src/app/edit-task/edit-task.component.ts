  ...
  context
    ...
    .then(function(selection) {
      ...
      selection.forEach(function(selected) {
        let imageSourcePromise = new Promise<string>((resolve, reject) => {
          ImageSource.fromAsset(selected).then(
        ...
        promises.push(imageSourcePromise);
      });

      // Wait for all the image saving promises to resolve
      return Promise.all(promises);
    })
    .then(function(savedFilePaths) {
      // Handle the saved file paths if needed
